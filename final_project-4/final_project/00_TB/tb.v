...
`define END_CYCLE 100000000000 // You can modify your maximum cycles
...
module Final_tb;
    ...
    //         integer file;
    //         file = $fopen(`LOG, "w+");
    //         if (error_num > 0)  $fdisplay(file, "FAIL, 0");
    //         else                $fdisplay(file, "PASS, %d", cyc);
    //     end
    // endtask
endmodule